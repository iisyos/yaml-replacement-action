...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    import_file_exists = __nccwpck_require__(5219);
    NULL = "\0";
    NOOP = () => {
    };
...
var init_completion_detection_plugin = __esm({
  "src/lib/plugins/completion-detection.plugin.ts"() {
    import_promise_deferred = __nccwpck_require__(8213);
    init_utils();
...
var init_git_logger = __esm({
  "src/lib/git-logger.ts"() {
    import_debug = __toESM(__nccwpck_require__(7763));
    init_utils();
...
var init_scheduler = __esm({
  "src/lib/runners/scheduler.ts"() {
    init_utils();
    import_promise_deferred2 = __nccwpck_require__(8213);
    init_git_logger();
    createScheduledTask = (() => {
      let id = 0;
      return () => {
...
const git = __nccwpck_require__(6874);
...
const { main } = __nccwpck_require__(9054);
